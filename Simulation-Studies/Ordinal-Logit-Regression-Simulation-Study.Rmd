---
title: "Ordinal Logit Regression Simulation Study"
...
```{r}
generate.and.estimate.ordinal.logit.regression <- function(n, intercept, slope, threshold) {
  x <- rnorm(n)
...
estimated.parameters <- parameters %>%
  ...
  rowwise() %>%
  mutate(
    generate.and.estimate.ordinal.logit.regression(
      n = n.data,
      intercept = intercept,
      slope = slope,
      threshold = threshold
